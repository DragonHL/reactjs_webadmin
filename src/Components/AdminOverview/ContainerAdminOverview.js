...
function ContainerAdminOverview() {
    ...
    function arrayStatisticalFollowMonthOne(month) {
        ...
        for (var item of dataOrder) {
            ...
            if (
                ...
                (parseFloat(arrayStartDate[2]) <= parseFloat(arrayDateOfOrder[2])) &&
                (parseFloat(arrayEndDate[2]) <= parseFloat(arrayDateOfOrder[2]))
            ) {
    ...
    function statisticalMonth() {
        ...
        for (var item of dataOrder) {
            arrayDateOfOrder = (item.val().date).match(/\d+/g);
            if (
                (parseFloat(arrayDateOfOrder[1]) === parseFloat(arrayStartDate[1])) &&
                (parseFloat(arrayDateOfOrder[1]) === parseFloat(arrayEndDate[1])) &&
                (parseFloat(arrayStartDate[2]) === parseFloat(arrayDateOfOrder[2])) &&
                (parseFloat(arrayEndDate[2]) === parseFloat(arrayDateOfOrder[2]))) {
                totalPrice += item.val().totalprice;
                // count++;
    ...
    function statisticalYear() {
        ...
        for (var item of dataOrder) {
            arrayDateOfOrder = (item.val().date).match(/\d+/g);
            if ((parseFloat(arrayStartDate[2]) === parseFloat(arrayDateOfOrder[2])) &&
                (parseFloat(arrayEndDate[2]) === parseFloat(arrayDateOfOrder[2]))) {
                totalPrice += item.val().totalprice;
                count++;
            }
    ...
    function statisticalDay() {
        ...
        for (var item of dataOrder) {
            arrayDateOfOrder = (item.val().date).match(/\d+/g);
            if (
                (parseFloat(arrayStartDate[0]) <= parseFloat(arrayDateOfOrder[0])) &&
                (parseFloat(arrayDateOfOrder[0]) <= parseFloat(arrayEndDate[0])) &&
                (parseFloat(arrayDateOfOrder[1]) === parseFloat(arrayStartDate[1])) &&
                (parseFloat(arrayDateOfOrder[1]) === parseFloat(arrayEndDate[1])) &&
                (parseFloat(arrayStartDate[2]) === parseFloat(arrayDateOfOrder[2])) &&
                (parseFloat(arrayEndDate[2]) === parseFloat(arrayDateOfOrder[2]))
