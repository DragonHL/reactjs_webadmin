...
function FormEdit_Discount(props) {
    ...
    const saveDiscount = () => {
        ...
        DiscountService.update(valuesDiscounts.key, data)
            .then(() => {
                setSubmitted(true);
                console.log("Update Discount Success!!")
            })
            .catch(e => {
                console.log(e);
            });
    ...
    return (
        <div className="sub-container">
            ...
            <h2 className="titleform">Form Edit Discount</h2>
...
export default FormEdit_Discount;